...
%"struct map_t" = type { ptr, ptr, ptr, ptr } ; an identified structure
%"struct map_t.0" = type { ptr, ptr, ptr, ptr }
%"struct map_t.1" = type { ptr, ptr }
%"struct map_t.2" = type { ptr, ptr, ptr, ptr }

; global variables
@LICENSE = global [4 x i8] c"GPL\00", section "license" ; LLVM allows an explicit section to be specified for globals.
...
; @BEGIN_1: @<func_name>
; (ptr %0): argument list
; setcion "s_BEGIN_1": section "name"
; !dbg & !52: tbd
...
if_body:                                          ; preds = %entry
  call void @llvm.lifetime.start.p0(i64 -1, ptr %"@res_key")
  store i64 0, ptr %"@res_key", align 8
  call void @llvm.lifetime.start.p0(i64 -1, ptr %"@res_val")
  store i64 1, ptr %"@res_val", align 8
  %update_elem1 = call i64 inttoptr (i64 2 to ptr)(ptr @AT_res, ptr %"@res_key", ptr %"@res_val", i64 0)
  call void @llvm.lifetime.end.p0(i64 -1, ptr %"@res_val")
  call void @llvm.lifetime.end.p0(i64 -1, ptr %"@res_key")
  br label %if_end
